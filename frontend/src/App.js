      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        {activeTab === 'admin' && user?.role === 'admin' && (
          ...
          <div className="border-t pt-8">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center space-x-4">
                <button
                  ...
                  className="px-4 py-2 bg-green-500 hover:bg-green-600 text-white text-sm rounded-lg transition-colors flex items-center"
                  disabled={marketingLoading}
                >
                  <RefreshCw className={`w-4 h-4 mr-2 ${marketingLoading ? 'animate-spin' : ''}`} />
                  Aktualisieren
                </button>
              </div>
            </div>
            ...
            {marketingLoading ? (
              <div className="flex items-center justify-center py-12">
                <RefreshCw className="w-8 h-8 text-green-500 animate-spin mr-3" />
                <span className="text-gray-600 text-lg">Lade Marketing-Daten...</span>
              </div>
            ) : launchMetrics ? (
              <>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-blue-600 font-medium">Neue Registrierungen</p>
                        <p className="text-2xl font-bold text-blue-800">{launchMetrics.new_registrations}</p>
                      </div>
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-green-600 font-medium">Premium Konversionen</p>
                        <p className="text-2xl font-bold text-green-800">{launchMetrics.premium_conversions}</p>
                      </div>
                  ...
                  <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-purple-600 font-medium">Referral Anmeldungen</p>
                        <p className="text-2xl font-bold text-purple-800">{launchMetrics.referral_signups}</p>
                      </div>
                  ...
                  <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-orange-600 font-medium">Aktive Nutzer (24h)</p>
                        <p className="text-2xl font-bold text-orange-800">{launchMetrics.daily_active_users}</p>
                      </div>
                ...
                <div className="flex border-b border-gray-200 mb-6">
                  {[
                    { id: 'overview', label: 'Launch Status', icon: Target },
                    ...
                    <button
                      key={tab.id}
                      onClick={() => setSelectedMarketingTab(tab.id)}
                      className={`flex items-center space-x-2 px-6 py-3 border-b-2 font-medium text-sm transition-colors ${
                        selectedMarketingTab === tab.id
                ...
                {selectedMarketingTab === 'overview' && (
                  <div className="space-y-6">
                    <div className="bg-white border border-gray-200 rounded-lg p-6">
                      ...
                      {launchChecklist.map((category, categoryIndex) => (
                        <div key={categoryIndex} className="mb-6">
                          <h5 className="font-medium text-gray-700 mb-3 text-sm uppercase tracking-wide">
                            {category.category}
                          </h5>
                          <div className="space-y-2">
                            {category.items.map((item, itemIndex) => (
                              <div key={itemIndex} className="flex items-center space-x-3 p-2 rounded">
                                <div className={`w-2 h-2 rounded-full ${item.completed ? 'bg-green-500' : 'bg-yellow-500'}`}></div>
                  ...
                  <div className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div className="bg-white border border-gray-200 rounded-lg p-6">
                        <h4 className="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                          <FileText className="w-5 h-5 mr-2 text-blue-600" />
                          Vorgefertigte Vorlagen ({marketingTemplates.predefined_templates?.length || 0})
                        </h4>
                        
                        {marketingTemplates.predefined_templates?.map((template, index) => (
                          <div key={index} className="border border-gray-200 rounded-lg p-4 mb-3 hover:bg-gray-50">
                            <div className="flex items-start justify-between">
                              <div className="flex-1">
                                <h5 className="font-medium text-gray-800">{template.name}</h5>
                                <p className="text-sm text-gray-600 capitalize">{template.type} • {template.category}</p>
                                {template.subject && (
                                  <p className="text-sm text-blue-600 mt-1">"{template.subject}"</p>
                                )}
                                <div className="flex flex-wrap gap-1 mt-2">
                                  {template.variables?.map((variable, vIndex) => (
                                    <span key={vIndex} className="px-2 py-1 bg-gray-100 text-xs rounded">
                                      {`{{${variable}}}`}
                                    </span>
                                  ))}
                                </div>
                              </div>
                              <button className="ml-4 px-3 py-1 bg-blue-500 hover:bg-blue-600 text-white text-xs rounded transition-colors">
                                Verwenden
                              </button>
                            </div>
                          </div>
                      ...
                      <div className="bg-white border border-gray-200 rounded-lg p-6">
                        <div className="flex items-center justify-between mb-4">
                          <h4 className="text-lg font-semibold text-gray-800 flex items-center">
                            ...
                            Eigene Vorlagen ({marketingTemplates.custom_templates?.length || 0})
                          </h4>
                        ...
                        {marketingTemplates.custom_templates?.length > 0 ? (
                          <div className="space-y-3">
                            {marketingTemplates.custom_templates.map((template, index) => (
                              <div key={index} className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50">
                                <h5 className="font-medium text-gray-800">{template.name}</h5>
                                <p className="text-sm text-gray-600 capitalize">{template.type} • Verwendet: {template.usage_count}x</p>
                              </div>
                            ))}
                          </div>
                        ) : (
                          <div className="text-center py-8">
                            ...
                            <p className="text-gray-500">Noch keine eigenen Vorlagen</p>
                          </div>
                        )}
                      </div>
                    </div>
                ...
                {selectedMarketingTab === 'social' && (
                  <div className="space-y-6">
                    <div className="bg-white border border-gray-200 rounded-lg p-6">
                      ...
                      {socialPosts.ready_to_use_posts?.map((post, index) => (
                        <div key={index} className="border border-gray-200 rounded-lg p-4 mb-4 hover:bg-gray-50">
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              ...
                              <p className="text-sm text-gray-700 mb-3">{post.content.substring(0, 200)}...</p>
              ...
              <div className="text-center py-12">
                <Send className="w-16 h-16 text-gray-400 mx-auto mb-4" />
                <p className="text-gray-500 text-lg">Marketing-Daten nicht verfügbar</p>
                <p className="text-gray-400">Laden Sie die Daten neu oder überprüfen Sie Ihre Berechtigung.</p>
              </div>
            )}
          </div>
